  ...
  describe "POST /create" do
    context 'create user' do
      it "user creates a successfuly" do
        post :create, params: { name:"rj",user_type:"Admin",email:"rj@gamil.com", password_digest: user.password_digest }
        expect(response.status).to eq(201)
      end
      it "with invalid params" do
        post :create, params: { name:"rj",user_type:"Admidn",email:"rj@gamil.com", password_digest: user.password_digest }
