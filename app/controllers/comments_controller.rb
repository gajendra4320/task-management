...
class CommentsController < ApiController
  load_and_authorize_resource
    ...
    def update
      ...
      render json: CommentSerializer.new(@comment).serializable_hash.merge(message: 'Comment updated successfully'), status: :ok
    end
    ...
    def destroy
      ...
      render json: CommentSerializer.new(@comment).serializable_hash.merge(message: 'Comment deleted successfully'), status: :ok
    end
